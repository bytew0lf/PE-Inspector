...
- Debug directory: implemented (CodeView/PDB)
- Relocations: implemented (summaries + anomalies)
- Exception directory: implemented (unwind + validation)
- TLS: implemented (callbacks + mapping)
- Load config: implemented (guard flags, CHPE, dynamic reloc tables)
