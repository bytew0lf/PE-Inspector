...
- TLS: implemented (callbacks + raw data mapping/alignment, hash/preview)
...
- Certificates/Authenticode: implemented (PKCS7/signers/timestamps, certificate transparency hints, catalog lookup on Windows)
